...
(expect
  ...
  (let [] 
    ...
    (def result (. rsc shouldReturnCachedResult  test-query (new java.sql.Timestamp (. (parse-date "2018-08-23 06:00") getTime))))
    (. rsc cancel)
    result
  )))
...
(expect
  ...
  (let [] 
    (def rsc (new RedshiftStateCache 1 (new DummySetTableLastUpdated { "SCHEMA1" { "TABLE1" (parse-date "2018-08-23 02:00") "TABLE2" (parse-date "2018-08-23 03:00")} 
                                                                        "SCHEMA2" { "TABLE1" (parse-date "2018-08-23 04:00") "TABLE2" (parse-date "2018-08-23 05:00")} })))
    (def result (. rsc shouldReturnCachedResult  test-query (new java.sql.Timestamp (. (parse-date "2018-08-23 01:00") getTime))))
    (. rsc cancel)
    result
  )))
...
(expect
  ...
  (let [] 
    (def rsc (new RedshiftStateCache 1 (new DummySetTableLastUpdated { "SCHEMA1" { "TABLE1" (parse-date "2018-08-23 02:00") "TABLE2" (parse-date "2018-08-23 03:00")} 
                                                                        "SCHEMA2" { "TABLE1" (parse-date "2018-08-23 04:00") "TABLE2" (parse-date "2018-08-23 05:00")} })))
    (def result (. rsc shouldReturnCachedResult  (assoc-in test-query [:native :query] "SELECT * FROM table1") (new java.sql.Timestamp (. (parse-date "2018-08-23 06:00") getTime))))
    (. rsc cancel)
    result
  )))
...
(expect
  ...
  (let [] 
    (def rsc (new RedshiftStateCache 1 (new DummySetTableLastUpdated { "SCHEMA1" { "TABLE1" (parse-date "2018-08-23 02:00") "TABLE2" (parse-date "2018-08-23 03:00")} 
                                                                        "SCHEMA2" { "TABLE1" (parse-date "2018-08-23 04:00") "TABLE2" (parse-date "2018-08-23 05:00")} })))
    (def result (. rsc shouldReturnCachedResult  (assoc-in test-query [:native :query] "SELECT * FROM table1") (new java.sql.Timestamp (. (parse-date "2018-08-23 03:00") getTime))))
    (. rsc cancel)
    result
  )))
...
(expect
  ...
  (let [] 
    (def rsc (new RedshiftStateCache 1 (new DummySetTableLastUpdated { "SCHEMA1" { "TABLE1" (parse-date "2018-08-23 02:00") "TABLE2" (parse-date "2018-08-23 03:00")} 
                                                                        "SCHEMA2" { "TABLE1" (parse-date "2018-08-23 04:00") "TABLE2" (parse-date "2018-08-23 05:00")} })))
    (def result (. rsc shouldReturnCachedResult  (assoc-in test-query [:native :query] "SELECT * FROM missingschema.table1")  (new java.sql.Timestamp (. (parse-date "2018-08-23 01:00") getTime))))
    (. rsc cancel)
    result
  )))
...
(expect
  ...
  (let [] 
    (def rsc (new RedshiftStateCache 1 (new DummySetTableLastUpdated { "SCHEMA1" { "TABLE1" (parse-date "2018-08-23 02:00") "TABLE2" (parse-date "2018-08-23 03:00")} 
                                                                        "SCHEMA2" { "TABLE1" (parse-date "2018-08-23 04:00") "TABLE2" (parse-date "2018-08-23 05:00")} })))
    (def result (. rsc shouldReturnCachedResult  (assoc-in test-query [:native :query] "SELECT * FROM schema1.missingtable")  (new java.sql.Timestamp (. (parse-date "2018-08-23 01:00") getTime))))
    (. rsc cancel)
    result
  )))
...
(expect
  ...
  (let [] 
    (def rsc (new RedshiftStateCache 1 (new DummySetTableLastUpdated { "SCHEMA1" { "TABLE1" (parse-date "2018-08-23 02:00") "TABLE2" (parse-date "2018-08-23 03:00")} 
                                                                        "SCHEMA2" { "TABLE1" (parse-date "2018-08-23 04:00") "TABLE2" (parse-date "2018-08-23 05:00")} })))
    (def result (. rsc shouldReturnCachedResult  (assoc-in test-query [:native :query] "SELECT * FROM missingtable")  (new java.sql.Timestamp (. (parse-date "2018-08-23 01:00") getTime))))
    (. rsc cancel)
    result
  )))
